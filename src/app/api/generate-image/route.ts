      ...
      try {
        ...
        try {
          ...
          throw new Error('Invalid response structure from OpenAI API');
            ...
            console.error('Server: Buffer conversion error:', bufferError);
            throw new Error(`Buffer conversion failed: ${bufferError instanceof Error ? bufferError.message : String(bufferError)}`);
          }
        } catch (downloadError) {
          console.error('Server: Image download error:', downloadError);
          throw downloadError;
        }
      } catch (openaiError) {
