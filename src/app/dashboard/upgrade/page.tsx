        ...
        <div className="bg-white dark:bg-[#18181b] rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 max-w-4xl mx-auto">
            ...
            <div className="bg-[#f8fafc] dark:bg-[#27272a] rounded-xl p-6 border border-[#e5e7eb] dark:border-[#334155] flex flex-col">
              <h3 className="text-xl font-semibold text-[#1d2939] dark:text-white mb-2">Standard Plan</h3>
              <div className="text-3xl font-bold text-[#2563eb] mb-4">$99<span className="text-sm text-[#64748b] dark:text-[#94a3b8] font-normal">/month</span></div>
            ...
            <div className="bg-[#eff6ff] dark:bg-[#1e3a8a] rounded-xl p-6 border-2 border-[#2563eb] flex flex-col relative">
              ...
              <h3 className="text-xl font-semibold text-[#1d2939] dark:text-white mb-2">Agency Plan</h3>
              <div className="text-3xl font-bold text-[#2563eb] mb-4">$397<span className="text-sm text-[#64748b] dark:text-[#94a3b8] font-normal">/month</span></div>
              <ul className="mb-6 flex-grow">
                <li className="flex items-center mb-2 text-[#475569] dark:text-[#cbd5e1]">
                  <svg className="w-5 h-5 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <strong>300 AI photo transformations</strong>
                </li>
                <li className="flex items-center mb-2 text-[#475569] dark:text-[#cbd5e1]">
                  <svg className="w-5 h-5 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
