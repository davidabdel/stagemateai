...
import OpenAIDebugButton from '@/components/OpenAIDebugButton';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header className="bg-white dark:bg-gray-800 shadow-sm mb-8 p-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold text-[#1d2939] dark:text-white">Admin Debug Tools</h1>
            <div className="flex space-x-4">
              <Link href="/admin" className="text-[#2563eb] hover:underline">Back to Admin</Link>
        ...
        <main>
          ...
          {/* Additional debug tools can be added here */}
        </main>
      </div>
    </div>
  );
