...
// Use the same anon key as the regular client since we don't have a valid service role key
...
// Note: This won't bypass RLS, but we'll use it for admin operations
